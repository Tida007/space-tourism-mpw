...
function CrewContents() {
    ...
    const currentCrew = crews.find((des) => des.name.toLowerCase() === activeName.toLowerCase());
    ...
    return (
        ...
        <ContentsContainer dir="rtl">
            <ImageContainer>
                <img src={currentCrew.images?.webp || currentCrew.image?.webp} alt={currentCrew.name} />
            </ImageContainer>
